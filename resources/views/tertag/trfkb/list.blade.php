                                        ...
                                        @foreach ($invoices as $invoice)
                                            <tr>
                                                <td><button class="btn btn-primary btn-sm mb-0"
                                                        onclick="window.location='{{ url($url_menu . '/show/' . encrypt($invoice->id)) }}'">View</button>
                                                </td>
                                                <td>{{ $loop->iteration }}</td>
                                                <td>{{ $invoice->nomor_form }}</td>
                                                <td>{{ $invoice->nomor_faktur_pemasok }}</td>
                                                <td>{{ $invoice->tanggal_faktur }}</td>
                                                <td>{{ $invoice->pemasok }}</td>
